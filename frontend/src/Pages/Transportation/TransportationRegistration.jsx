...
import { UserPlus, Mail, Lock, Phone, Building2, MapPin,LeafIcon, Truck } from 'lucide-react';

const TransportationRegistration
 = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/transportation-register', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    TransportationName: formData.TransportationName,
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div className="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10 border border-green-100">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        {/* Transportation Name */}
                        <div>
                            <label htmlFor="TransportationName" className="block text-sm font-medium text-green-700">
                                Transportation Name
                            </label>
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    value={formData.TransportationName}
                                    onChange={handleChange}
                                    className="pl-10 block w-full pr-3 py-2 border border-green-300 rounded-md leading-5 bg-white placeholder-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm"
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="pl-10 block w-full pr-3 py-2 border border-green-300 rounded-md leading-5 bg-white placeholder-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                    placeholder="123 Transporter, City, State, PIN"
                                />
                            </div>
                        </div>
